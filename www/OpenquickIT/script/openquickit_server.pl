...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{OPENQUICKIT_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{OPENQUICKIT_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
openquickit_server.pl - Catalyst Testserver

=head1 SYNOPSIS

openquickit_server.pl [options]
